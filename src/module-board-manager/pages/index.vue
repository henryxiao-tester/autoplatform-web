<template>
  <div class="dashboard-container">
    <div class="app-container">
      <body>
        <header>
          <h1 style="cursor:pointer" @click="startFullScreen">
            AutoPlatform - Board
          </h1>
...
export default {
  ...
  methods: {
    ...
    initMapOne() {
      ...
      this.$axios
        .post(baseUrl.domain + baseInterface.getBoardDataForTaskOne, {
          taskId: 111111
        })
        .then(res => {
    ...
    initMapTwo() {
      ...
      this.$axios
        .post(baseUrl.domain + baseInterface.getBoardDataForTaskTwo, {
          taskId: 2222222
        })
        .then(res => {
          if (res.data.code === 20000) {
    ...
    initMapThree() {
      ...
      this.$axios
        .post(baseUrl.domain + baseInterface.getBoardDataForTaskThree, {
          taskId: 33333333
        })
        .then(res => {
          if (res.data.code === 20000) {
    ...
    initMapFour() {
      ...
      this.$axios
        .post(baseUrl.domain + baseInterface.getBoardDataForTaskFour, {
          taskId: 412132323232
        })
        .then(res => {
          if (res.data.code === 20000) {
    ...
    initMapFive() {
      ...
      this.$axios
        .post(baseUrl.domain + baseInterface.getBoardDataForTaskFive, {
          taskId: 512132323232
        })
        .then(res => {
          if (res.data.code === 20000) {
